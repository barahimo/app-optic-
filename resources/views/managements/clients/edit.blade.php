            ...
            <div  class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 transparence">
                        ...
                        <div class="col-md-12">
                            <input type="text" class="form-control" name="name" placeholder="name" value="{{ old('name', $client->nom_client ?? null) }}"  >
                        </div>
                        ...
                        <div class="col-md-12">
                            <input type="text" class="form-control" name="solde" placeholder="solde"  value="{{ old('solde', $client->solde ?? null) }}"  >
                        </div>
                        <label class="label col-md-9 control-label">Code :</label>
                        <div class="col-md-12">
                            <input type="text" class="form-control" name="code" placeholder="code"  value="{{ old('adresse', $client->adresse ?? null) }}"  >
                        </div>
