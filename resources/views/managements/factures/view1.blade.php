...
<body>
                                ...
                                <table class="table table-hover" border="0" style="border: 0px solid red">
                                    ...
                                    <tbody style="font-size : 8px">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:45%;" class="text-left border-right border-left">{{$lignecommande->nom_produit}}</td>
                                            <td style="width:5%;" class="text-center border-right border-left">{{$lignecommande->Qantite}}</td>
    ...
    <script type="application/javascript">
        function dimensionTBODY(){
            ...
            tbody_ligne = lignes.eq(lignes.length - 4);
