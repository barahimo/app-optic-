                ...
                <div class="row">
                    ...
                    <div class="col-md-6 transparence">
                        ...
                        <form  method="POST" action="{{route('produit.update',['produit'=> $produit])}}">
                            ...
                            <div class="col-md-12">
                                <input type="text" class="form-control" name="descreption" placeholder="descreption" value="{{ old('descreption', $produit->descreption ?? null) }}" >
                            </div>
                            ...
                            <div class="col-md-12">
                                <input type="text" class="form-control" name="nom_categorie" placeholder="descreption" value="{{ old('nom_categorie', $produit->nom_categorie ?? null) }}" readonly>
                            </div>
